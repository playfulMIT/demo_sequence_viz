...
from .views import Seq, Persistence, bentoBox, monsterMap, competencyElo, portalPersistence
...
urlpatterns = [
    ...
    path('portalpersistence', portalPersistence, name='portalpersistence'),
    path('competency', competencyElo, name='competency')
]
